...
npm run lint             # ESLint
npm run test:unit        # Vitest unit tests (40 tests, one-shot)
npm run test:unit:watch  # Vitest watch mode
npm run test:e2e         # Playwright e2e (12 tests — builds frontend, starts backend on :8000)
